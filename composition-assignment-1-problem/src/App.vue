...
export default {
  setup(){
      const courseGoal = 'finish the course';
      let goalVisible = ref(false);

      function toggleGoalVisibility(){
        goalVisible.value = !goalVisible.value
      }
      return {goal: courseGoal, goalIsVisible: goalVisible, toggleGoalVisibility}
  }
}
</script>
